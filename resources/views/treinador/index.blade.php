@extends('template.main', ['menu' => 'admin', 'submenu' => 'Treinadores', 'rota' => 'treinador.create'])
            ...
            <table class="tabela_treinador table align-middle caption-top table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->regiao }}</td>
                        <td>
                            <a href="{{ route('treinador.edit', $item->id) }}" class="btn_edit edit btn">
                        ...
                        <form action="{{ route('treinador.destroy', $item->id) }}" method="POST"
                            id="form_{{ $item->id }}">
                            @csrf
                            @method('DELETE')
                        </form>
