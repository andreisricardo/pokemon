@extends('template.main', ['menu' => "admin", 'submenu' => "Novo Pokémon"])
...
<form action="{{ route('pokemon.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="form mb-3">
                <select class="form-control @if($errors->has('tipo1')) is-invalid @endif" name="tipo1" placeholder="Tipo 1">{{old('tipo1')}}
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="form mb-3">
                <select class="form-control @if($errors->has('tipo2')) is-invalid @endif" name="tipo2" placeholder="Tipo 2">{{old('tipo2')}}
                    <option value="">Selecione um tipo</option>
    ...
    <div class="row">
        <div class="col" >
            <div class="input-group mb-3">
                <span class="btn-foto input-group-text text-white">Foto</span>
    ...
    <div class="row">
        <div class="col">
            <a href="{{route('pokemon.index')}}" class="btn btn-secondary btn-block align-content-center">
